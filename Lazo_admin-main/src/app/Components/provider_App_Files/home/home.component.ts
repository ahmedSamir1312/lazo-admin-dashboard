...
export class HomeComponent implements OnInit {
  ...
  editTerms() {
    ...
    if (this.files?.provider_app_info?.terms_conditions_path) {
      // In a real scenario, you might want to fetch the text content from the file
      // For now, we'll clear the path and allow editing
      this.files.provider_app_info.terms_conditions_path = null;
      this.isEditingTerms = true;
    }
  }

  editAbout() {
    if (this.files?.provider_app_info?.about_app_path) {
      this.files.provider_app_info.about_app_path = null;
