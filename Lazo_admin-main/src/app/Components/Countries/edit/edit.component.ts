...
export class EditComponent {
  ...
  add() {
    ...
    let form = {
      country_id: this.category.id,
      ...this.form.value,
    };
    this.cats.editCountry(form).subscribe(
      (res: any) => {
